...
const StocksPage = () => {
  ...
  const fetchStocks = async () => {
    try {
      const response = await axios.get('https://codebrewrepo-zeta.vercel.app/api/menu-items');
  ...
  const handleUpdateStock = async (id, newStock) => {
    ...
    try {
      const response = await axios.put('https://codebrewrepo-zeta.vercel.app/api/menu-items', { _id: id, stock: newStock });
