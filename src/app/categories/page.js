...
export default function CategoriesPage() {
  ...
  function fetchCategories() {
    fetch('https://codebrewrepo-1.onrender.com/api/categories')
      .then(res => res.json())
      .then(categories => {
  ...
  async function handleCategorySubmit(ev) {
    ...
    const response = await fetch('https://codebrewrepo-1.onrender.com/api/categories', {
      method,
  ...
  async function handleDeleteClick(_id) {
    const response = await fetch(`https://codebrewrepo-1.onrender.com/api/categories?_id=${_id}`, {
      method: 'DELETE',
    });
