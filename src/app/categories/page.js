...
export default function CategoriesPage() {
  ...
  async function handleCategorySubmit(ev) {
    ...
    const response = await fetch('https://codebrewrepo.onrender.com/api/categories', {
      method,
  ...
  async function handleDeleteClick(_id) {
    const response = await fetch(`https://codebrewrepo.onrender.com/api/categories?_id=${_id}`, {
      method: 'DELETE',
    });
