...
export default function ProfilePage() {
  ...
  useEffect(() => {
    ...
    if (status === 'authenticated') {
      ...
      fetch('https://tealerin-koih0jxmd-codebrew-8f15525b.vercel.app/api/profile')
  ...
  async function handleProfileInfoUpdate(ev, data) {
    ...
    const savingPromise = new Promise(async (resolve, reject) => {
      const response = await fetch('https://tealerin-koih0jxmd-codebrew-8f15525b.vercel.app/api/profile', {
        method: 'PUT',
